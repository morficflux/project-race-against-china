  ...
  create(): void {
    ...
    if (this.textures.exists('bg-title')) {
      ...
      this.add
        ...
        .setDepth(-100);
      // Wash it out — full-strength crayon competes with the dark text on
      // top (title logo aside, which has its own solid backing).
      this.add.rectangle(640, 360, 1280, 720, 0xffffff, 0.7).setDepth(-99);
    }
